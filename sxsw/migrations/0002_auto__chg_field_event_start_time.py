...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'sxsw_event', 'start_time', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Event.start_time'
        db.alter_column(u'sxsw_event', 'start_time', self.gf('django.db.models.fields.DateField')())

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.is_recommended'
        db.add_column(u'sxsw_event', 'is_recommended',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Event.recommended_for'
        db.add_column(u'sxsw_event', 'recommended_for',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.is_recommended'
        db.delete_column(u'sxsw_event', 'is_recommended')

        # Deleting field 'Event.recommended_for'
        db.delete_column(u'sxsw_event', 'recommended_for')
